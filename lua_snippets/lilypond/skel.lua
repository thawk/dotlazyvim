...
"@1?Melody" = \"@1?Notes"
...
]],
      {
        ...
        [2] = d(2, function(args, parent)
          return sn(nil, { i(2, args[1][1] or "") })
        end, { 1 }),
        [3] = i(3, "C"),
        [4] = i(4, "c''"),
        [5] = i(5, "4/4"),
        x1 = f(function(args)
          return (args[1][1] or ""):gsub("[,']+", "")
        end, { 6 }),
        [7] = i(7, "\\major"),
        [0] = i(0),
        [8] = i(8, "60"),
  ...
  s(
    { trig = [[skel]], desc = [[Notes with lyric]] },
    fmt(
      [[
"@1?Piece" = "@2?"
"@1?Opus" = ""
...
"@1?Melody" =
{
  ...
  s(
    { trig = [[skel]], desc = [[Parallel Notes (one staff)]] },
    fmt(
      [[
"@1?Piece" = "@2?"
"@1?Opus" = ""
...
"@1?Melody" = \"@1?Notes"
  ...
  s(
    { trig = [[skel]], desc = [[Parallel Notes (1 staffs with lyric)]] },
    fmt(
      [[
"@1?Piece" = "@2?"
"@1?Opus" = ""
...
"@1?Melody" =
{
  ...
  s(
    { trig = [[skel]], desc = [[Parallel Notes (two staffs)]] },
    fmt(
      [[
"@1?Piece" = "@2?"
"@1?Opus" = ""
...
"@1?Melody" = \"@1?Notes"
  ...
  s(
    { trig = [[skel]], desc = [[Parallel Notes (two staffs separated)]] },
    fmt(
      [[
"@1?Piece" = "@2?"
"@1?Opus" = ""
