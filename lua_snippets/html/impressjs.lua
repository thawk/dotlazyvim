...
return {
  ...
  ls.snippet([[skel]], {
    ...
    ls.text_node({"</h1>", "    <p>"}),
    ls.insert_node(3, ls.function_node(function() return vim.env.USER or "" end)),
    ls.text_node({"</p>", "    <p><small>"}),
    ls.insert_node(4, ls.function_node(function() return os.date("%Y-%m-%d") end)),
  ...
  }, { description = [[impress.js template]] }),
